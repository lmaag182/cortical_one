...
'/home/hans/.local/lib/python2.7/site-packages/nupic/swarming/exp_generator/ExpGenerator.pyc'
"""
...
permutations = {
  ...
  'modelParams': {
    ...
    'sensorParams': {
      'encoders': {
          u's1': PermuteEncoder(fieldName='s1', w=21, clipInput=True, encoderClass='AdaptiveScalarEncoder', n=PermuteInt(22, 521), ),
  '_classifierInput': dict(classifierOnly=True, fieldname='s1', w=21, clipInput=True, type='AdaptiveScalarEncoder', n=PermuteInt(28, 521), ),
  u's2': PermuteEncoder(fieldName='s2', w=21, clipInput=True, encoderClass='AdaptiveScalarEncoder', n=PermuteInt(22, 521), ),
  u's3': PermuteEncoder(fieldName='s3', w=21, clipInput=True, encoderClass='AdaptiveScalarEncoder', n=PermuteInt(22, 521), ),
  u's4': PermuteEncoder(fieldName='s4', w=21, clipInput=True, encoderClass='AdaptiveScalarEncoder', n=PermuteInt(22, 521), ),
      },
    },
...
#       report generator
# (generated from minimize = "multiStepBestPredictions:multiStep:errorMetric='altMAPE':steps=\[4\]:window=1000:field=s1")
minimize = "multiStepBestPredictions:multiStep:errorMetric='altMAPE':steps=\[4\]:window=1000:field=s1"
